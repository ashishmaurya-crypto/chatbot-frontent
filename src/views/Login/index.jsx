...
import logo from './../../App/Assests/chat.png'
...
export default function Login() {
  ...
  if (localStorage.getItem("chatToken")) return <Navigate to="/chat/home" />;

  return (
    <div className='login-main-container'>
      <div className='back-header' onClick={()=> navigate('/')}>
        <Icon icon="ion:arrow-back-circle-sharp" width={35} /> Home
      </div>
