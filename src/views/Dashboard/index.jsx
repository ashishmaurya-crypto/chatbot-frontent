    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="6em" height="6em" viewBox="0 0 24 24">
        <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="30%" style={{ stopColor: 'rgba(2,0,36,1)', stopOpacity: 1 }} />
                <stop offset="72%" style={{ stopColor: 'rgba(9,9,121,1)', stopOpacity: 1 }} />
